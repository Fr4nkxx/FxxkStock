...
these (or a thin vendor-named subclass) and needs no new ``except`` clause.
    ...
    ├── BrowserUnavailableError    CDP/Playwright unavailable -> skip to next vendor
...
class BrowserUnavailableError(VendorError):
    """Playwright/CDP browser is unavailable; the router skips to the next vendor."""
