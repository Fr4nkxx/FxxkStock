...
import fxxkstock.agents.utils.agent_utils as au
import fxxkstock.dataflows.yfinance_news as ynews
import fxxkstock.graph.fxxkstock_graph as tg
...
def test_fetch_returns_normalizes_symbol(monkeypatch):
    ...
    raw, alpha, days = FxxKStockGraph._fetch_returns(
