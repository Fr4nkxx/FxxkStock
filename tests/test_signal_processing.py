...
header.  The deterministic heuristic in ``fxxkstock.agents.utils.rating``
...
from fxxkstock.agents.utils.rating import RATINGS_5_TIER, parse_rating
from fxxkstock.graph.signal_processing import SignalProcessor
